...
import com.example.a7_minute_workout.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private fun displayBMIResult(bmi : Float){
        ...
        if (bmi.compareTo(15f) <=0){
            ...
            bmiDescription = "OMG! You are in a very dangerous condition! Act now! Eat less and workout!!"
        }else{
